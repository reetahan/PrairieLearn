...
module.exports = {
    ...
    */
    ...
    _buildLocals(variant, question, instance_question, assessment, assessment_instance, grading_view) {
        const locals = {};
    ...
    getAndRenderVariant(variant_id, variant_seed, locals, callback) {
        async.series([
            ...
            (callback) => {
                ...
                const newLocals = this._buildLocals(variant, question, instance_question, assessment, assessment_instance, grading_view);
    ...
    renderPanelsForSubmission(submission_id, urlPrefix, questionContext, csrfToken, callback) {
        ...
        sqldb.queryOneRow(sql.select_submission_info, params, (err, results) => {
            ...
            _.assign(locals, this._buildLocals(variant, question, instance_question, assessment, assessment_instance, grading_view));
